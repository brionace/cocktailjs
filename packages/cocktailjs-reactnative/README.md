...
- `transform` (string): optional transform applied to the liquid path.
...
- No class-style methods are exposed; this package exports React Native components and data.
